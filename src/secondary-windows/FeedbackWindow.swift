...
// title is swapped for a hint. No caller uses it since the fork dropped the pre-form update check;
// kept because it is self-contained and upstream still drives it.
